...
Each Nixie Tube has a total of twelve pins, one Anode and eleven cathodes corresponding to the digits 0-9 and the Decimal point. Barring the decimal point, there needs to be a mechanism to choose between the 10 digits at any given instant. An off the shelf solution is available for the same in the form of the [SN74141 TTL IC](https://pdf1.alldatasheet.com/datasheet-pdf/view/115763/TI/SN74141.html). The differences between the 74141 and a regular BCD decoder such as the 7442 are the
...
could appear at the Cathodes of the Tube which are not turned on.
